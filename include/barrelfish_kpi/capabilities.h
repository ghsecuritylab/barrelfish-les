...
{
    STATIC_ASSERT(51 == ObjType_Num, "Check VNode definitions");
...
static inline size_t cnode_get_slots(struct capability *cnode) {
    STATIC_ASSERT(51 == ObjType_Num, "Check CNode definitions");
...
{
    STATIC_ASSERT(51 == ObjType_Num, "Knowledge of all mapping types");
...
{
    STATIC_ASSERT(51 == ObjType_Num, "Knowledge of all mappable types");
